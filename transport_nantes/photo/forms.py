    ...
    class Meta:
        ...
        widgets = {
            ...
            "relationship_to_competition": forms.Textarea(
                attrs={
                    "placeholder": (
                        "Exemples : J'y habite, J'y travaille,"
...
class AnonymousVoteForm(forms.Form):
    ...
    email_address = forms.EmailField(
        label="Adresse email :", required=False, help_text="Facultatif."
    )
...
class SimpleVoteFormWithConsent(forms.Form):
    ...
    consent_box = forms.BooleanField(
        label=(
            "Je préfère ne pas recevoir des nouvelles très occasionnelles"
