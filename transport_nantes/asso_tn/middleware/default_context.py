...
class DefaultContextMiddleware:
    social_media_context = {
        ...
        "og_twitter_title_default": (
            "Mobilitains - Pour une " "mobilité multimodale"
        ),
        "og_twitter_description_default": (
            "Nous agissons pour une mobilité "
    ...
    def __call__(self, request):
        context = RequestContext(request)  # noqa
