...
class TestsTopicItemForm(LiveServerTestCase):
    def setUp(self):
        ...
        self.user_editor_two = User.objects.create_user(
        ...
        self.user_editor_two_client.login(username="editor", password="editor")
        ...
        self.cookie_editor_two = self.user_editor_two_client.cookies[
            "sessionid"
        ].value
    ...
    def test_user_permited_create_auto_publish(self):
        ...
        self.assertIsNotNone(
            item_staff,
            msg="The item created by the super user" " is not in the database",
        )
        # Go to the user view
    ...
    def test_editor_create_item_but_cant_publish(self):
        ...
        self.assertIsNotNone(
            item_editor,
            msg="The item created by the editor" " is not in the database",
        )
        self.assertIsNone(
            item_editor.publication_date,
        ...
        response = Client().get(
            ...
            % (
                ...
                reverse(
                    "topic_blog:view_item_by_slug", kwargs={"the_slug": slug}
                ),
            )
        )
    ...
    def test_editor_create_and_another_publish(self):
        ...
        self.assertIsNotNone(
            item_editor.first_publication_date,
            msg="The first publication date" "should not be none",
        )
        # Check the user view
        self.selenium.find_element(By.LINK_TEXT, "Visualiser (usager)").click()
        """Get the body innerHTML and check if
    ...
    def test_edit_and_self_publish(self):
        ...
        self.fill_the_form_and_publish(
            slug="",
        ...
        self.assertIsNotNone(
            item_edited,
            msg="The item edited by the staff" " is not in the database",
        )
        # Go to the user view
        self.selenium.find_element(By.LINK_TEXT, "Visualiser (usager)").click()
        """Get the body innerHTML and check if
    ...
    def test_publish_an_unpublishable_item(self):
        ...
        self.assertIsNotNone(
            item_unpublishable,
            msg="The item created by the staff" " is not in the database",
        )
...
class TopicBlogEmailSeleniumTests(LiveServerTestCase):
    ...
    def setUp(self):
        ...
        self.cookie_normal_user = self.no_permissions_client.cookies[
            "sessionid"
        ].value
        ...
        self.neutral_url = self.live_server_url + reverse(
    ...
    def test_unsubscribe_to_mailing_list(self):
        ...
        url = self.live_server_url + reverse(
            "mailing_list:newsletter_unsubscribe", args=[token]
        )
        self.browser.get(url)

        # Confirm unsubscription
        self.browser.find_element(
            By.XPATH, '//button[normalize-space()="Oui"]'
        ).click()
