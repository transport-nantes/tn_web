...
@register.inclusion_tag(
    "topicblog/template_tags/launcher.html", takes_context=True
)
def launcher(context, slug, is_preview=False):
    if is_preview:
        ...
        launcher = (
            TopicBlogLauncher.objects.filter(
...
@register.inclusion_tag(
    "topicblog/template_tags/launcher_carousel.html", takes_context=True
)
...
@register.inclusion_tag(
    "topicblog/template_tags/item_teaser.html", takes_context=True
)
    ...
    if launcher is None:
        ...
        item = (
            TopicBlogItem.objects.filter(
                slug__iexact=launcher.article_slug,
...
@register.inclusion_tag(
    "topicblog/template_tags/item_teaser_index.html", takes_context=True
)
