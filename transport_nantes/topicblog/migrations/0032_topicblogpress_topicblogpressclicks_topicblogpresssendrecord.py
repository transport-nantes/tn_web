    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('press', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='topicblog.topicblogpresssendrecord')),
            ],
        ),
        migrations.CreateModel(
            name='TopicBlogPress',
            ...
            options={
                'permissions': (('tbp.may_view', 'May view unpublished TopicBlogPresss'), ('tbp.may_edit', 'May create and modify TopicBlogPresss'), ('tbp.may_publish', 'May publish TopicBlogPresss'), ('tbp.may_publish_self', 'May publish own TopicBlogPresss'), ('tbp.may_send', 'May send TopicBlogPresss'), ('tbp.may_send_self', 'May send own TopicBlogPresss')),
            },
        ),
    ]
