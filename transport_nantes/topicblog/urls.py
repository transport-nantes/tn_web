...
topicblogitem_urls = [
    ...
    path(
        "admin/t/view/<int:pkid>/",
        views.TopicBlogItemViewOne.as_view(),
        name="view_item_by_pkid_only",
    ),
    path(
        "admin/t/view/<int:pkid>/<slug:the_slug>/",
        views.TopicBlogItemViewOne.as_view(),
        name="view_item_by_pkid",
    ),
    path("admin/t/new/", views.TopicBlogItemEdit.as_view(), name="new_item"),
    path(
        "admin/t/edit/<int:pkid>/",
        views.TopicBlogItemEdit.as_view(),
        name="edit_item_by_pkid",
    ),
    path(
        "admin/t/edit/<int:pkid>/<slug:the_slug>/",
        views.TopicBlogItemEdit.as_view(),
        name="edit_item",
    ),
    path(
        "admin/t/edit/<slug:the_slug>/",
        views.TopicBlogItemEdit.as_view(),
        name="edit_item_by_slug",
    ),
    path(
        "admin/t/list/", views.TopicBlogItemList.as_view(), name="list_items"
    ),
    path(
        "admin/t/list/<slug:the_slug>/",
...
topicblogemail_urls = [
    ...
    path(
        "admin/e/view/<int:pkid>/",
        views.TopicBlogEmailViewOne.as_view(),
        name="view_email_by_pkid_only",
    ),
    path(
        "admin/e/view/<int:pkid>/<slug:the_slug>/",
        views.TopicBlogEmailViewOne.as_view(),
        name="view_email_by_pkid",
    ),
    path("admin/e/new/", views.TopicBlogEmailEdit.as_view(), name="new_email"),
    path(
        "admin/e/edit/<int:pkid>/",
        views.TopicBlogEmailEdit.as_view(),
        name="edit_email_by_pkid",
    ),
    path(
        "admin/e/edit/<int:pkid>/<slug:the_slug>/",
        views.TopicBlogEmailEdit.as_view(),
        name="edit_email",
    ),
    path(
        "admin/e/edit/<slug:the_slug>/",
        views.TopicBlogEmailEdit.as_view(),
        name="edit_email_by_slug",
    ),
    path(
        "admin/e/list/", views.TopicBlogEmailList.as_view(), name="list_emails"
    ),
    path(
        "admin/e/list/<slug:the_slug>/",
        views.TopicBlogEmailList.as_view(),
        name="list_emails_by_slug",
    ),
    path(
        "admin/e/send/<slug:the_slug>/",
...
topicblogpress_urls = [
    ...
    path(
        "admin/p/view/<int:pkid>/",
        views.TopicBlogPressViewOne.as_view(),
        name="view_press_by_pkid_only",
    ),
    path(
        "admin/p/view/<int:pkid>/<slug:the_slug>/",
        views.TopicBlogPressViewOne.as_view(),
        name="view_press_by_pkid",
    ),
    path("admin/p/new/", views.TopicBlogPressEdit.as_view(), name="new_press"),
    path(
        "admin/p/edit/<int:pkid>/",
        views.TopicBlogPressEdit.as_view(),
        name="edit_press_by_pkid",
    ),
    path(
        "admin/p/edit/<int:pkid>/<slug:the_slug>/",
        views.TopicBlogPressEdit.as_view(),
        name="edit_press",
    ),
    path(
        "admin/p/edit/<slug:the_slug>/",
        views.TopicBlogPressEdit.as_view(),
        name="edit_press_by_slug",
    ),
    path(
        "admin/p/list/", views.TopicBlogPressList.as_view(), name="list_press"
    ),
    path(
        "admin/p/list/<slug:the_slug>/",
        views.TopicBlogPressList.as_view(),
        name="list_press_by_slug",
    ),
    path(
        "admin/p/send/<slug:the_slug>/",
...
topicbloglauncher_urls = [
    ...
    path(
        "admin/la/edit/<int:pkid>/",
        views.TopicBlogLauncherEdit.as_view(),
        name="edit_launcher_by_pkid",
    ),
    path(
        "admin/la/edit/<int:pkid>/<slug:the_slug>/",
        views.TopicBlogLauncherEdit.as_view(),
        name="edit_launcher",
    ),
    path(
        "admin/la/edit/<slug:the_slug>/",
        views.TopicBlogLauncherEdit.as_view(),
...
topicblogmailinglistpitch_urls = [
    ...
    path(
        "admin/mlp/view/<int:pkid>/<slug:the_slug>/",
    ...
    path(
        "admin/mlp/edit/<int:pkid>/",
        views.TopicBlogMailingListPitchEdit.as_view(),
        name="edit_mlp_by_pkid",
    ),
    path(
        "admin/mlp/edit/<int:pkid>/<slug:the_slug>/",
        views.TopicBlogMailingListPitchEdit.as_view(),
        name="edit_mlp",
    ),
    path(
        "admin/mlp/edit/<slug:the_slug>/",
        views.TopicBlogMailingListPitchEdit.as_view(),
...
topicblogpanel_urls = [
    ...
    path(
        "admin/panel/view/<int:pkid>/",
        views.TopicBlogPanelViewOne.as_view(),
        name="view_panel_by_pkid_only",
    ),
    path(
        "admin/panel/view/<int:pkid>/<slug:the_slug>/",
        views.TopicBlogPanelViewOne.as_view(),
    ...
    path(
        "admin/panel/edit/<int:pkid>/",
        views.TopicBlogPanelEdit.as_view(),
        name="edit_panel_by_pkid",
    ),
    path(
        "admin/panel/edit/<int:pkid>/<slug:the_slug>/",
        views.TopicBlogPanelEdit.as_view(),
        name="edit_panel",
    ),
    path(
        "admin/panel/edit/<slug:the_slug>/",
        views.TopicBlogPanelEdit.as_view(),
    ...
    path(
        "admin/panel/list/<slug:the_slug>/",
        views.TopicBlogPanelList.as_view(),
        name="list_panel_by_slug",
    ),
]
ajax_urls = [
    path("ajax/get-slug-dict/", views.get_slug_dict, name="get_slug_dict"),
    path("ajax/get-url-list/", views.get_url_list, name="get_url_list"),
    path(
        "ajax/get-number-of-recipients/<str:mailing_list_token>/",
